...
namespace SMLYS.Infrastructure.Data.Migrations
{
    ...
    [Migration("20191016060450_AddTableIndustryCode")]
    partial class AddTableIndustryCode
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SMLYS.ApplicationCore.Entities.IndustryCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("SMLYS.ApplicationCore.Entities.InvoiceAggregate.InvoicePayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("SMLYS.ApplicationCore.Entities.PatientAggregate.PatientCardOnFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("SMLYS.ApplicationCore.Entities.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("SMLYS.ApplicationCore.Entities.ServiceGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("SMLYS.ApplicationCore.Entities.InvoiceAggregate.InvoicePayment", b =>
                {
                    ...
                    b.HasOne("SMLYS.ApplicationCore.Entities.Payment", "Payment")
                        .WithMany("InvoicePayment")
            ...
            modelBuilder.Entity("SMLYS.ApplicationCore.Entities.Item", b =>
                {
                    ...
                    b.HasOne("SMLYS.ApplicationCore.Entities.IndustryCode", "IndustryCode")
                        .WithMany("Items")
                        .HasForeignKey("IndustryCodeId")
                        .HasConstraintName("FK_Item_IndustryCode");

                    b.HasOne("SMLYS.ApplicationCore.Entities.ServiceGroup", "ServiceGroup")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("SMLYS.ApplicationCore.Entities.PatientAggregate.PatientCardOnFile", b =>
                {
                    b.HasOne("SMLYS.ApplicationCore.Entities.PatientAggregate.Patient", "Patient")
                        .WithMany("PatientCardOnFile")
                        .HasForeignKey("PatientId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("SMLYS.ApplicationCore.Entities.UserAggregate.SiteUser", "SiteUser")
                        .WithMany("PatientCardOnFileUpdatedByNavigation")
                        .HasForeignKey("UpdatedBy")
            ...
            modelBuilder.Entity("SMLYS.ApplicationCore.Entities.Payment", b =>
                {
                    ...
                    b.HasOne("SMLYS.ApplicationCore.Entities.UserAggregate.SiteUser", "SiteUser")
                        .WithMany("PaymentUpdatedByNavigation")
                        .HasForeignKey("UpdatedBy")
